                  ...
                  <div className="contact-info grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-black">
                    {profile.emailAddress && (
                      <div className="flex items-center justify-center sm:justify-start">
                        ...
                        <span className="text-sm sm:text-lg truncate">{profile.emailAddress}</span>
                      </div>
                    )}
                    {profile.phoneNumber && (
                      <div className="flex items-center justify-center sm:justify-start">
                    ...
                    {profile.stateOfResidence && profile.lgaOfResidence && (
                      <div className="flex items-center justify-center sm:justify-start">
                        ...
                        <span className="text-sm sm:text-lg truncate">{`${profile.lgaOfResidence}, ${profile.stateOfResidence}`}</span>
                      </div>
                    )}
                  </div>
                </div>
                      ...
                      <div className="content-section bg-white p-4 sm:p-6">
                        <div className="flex flex-wrap gap-2">
                          {profile.expertiseCompetencies.map((skill: string, index: number) => (
                            <span key={index} className="skill-badge bg-white text-black border border-gray-200 px-3 py-1 rounded-full text-sm">
                              {skill}
                            </span>
                          ))}
                        </div>
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <div className="content-section bg-white p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <span className="nysc-status bg-white text-black border border-black px-4 py-2 rounded-full text-center">
                        {profile.nyscStatus}
                      </span>
